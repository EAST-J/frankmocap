...
class ManopthWrapper(nn.Module):
    def __init__(self, mano_path='../data/smplx/mano/', **kwargs):
        super().__init__()
    ...
    def forward(self, glb_se3, art_pose, axisang=None, trans=None, 
                return_mesh=True, mode='outer', center=False,
                **kwargs) -> Tuple[Meshes, torch.Tensor]:
        # return 
